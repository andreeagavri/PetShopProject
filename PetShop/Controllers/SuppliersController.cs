...
using PetShopModel.Models.PetShopViewModels;
...
namespace PetShop.Controllers
{
    ...
    public class SuppliersController : Controller
    {
        ...
        public SuppliersController(PetShopContext context)
        {
            _context = context;
        }
        ...
        private void UpdateSuppliedProducts(string[] selectedProducts, Supplier supplierToUpdate)
        {
            ...
            foreach (var product in _context.Products)
            {
                if (selectedProductsHS.Contains(product.ProductID.ToString()))
                {
                    ...
                    {
                        supplierToUpdate.SuppliedProducts.Add(new SuppliedProduct
                        {
                ...
                else
                {
                    if (suppliedProducts.Contains(product.ProductID))
                    {
                        SuppliedProduct productToRemove = supplierToUpdate.SuppliedProducts.FirstOrDefault(i
